...
---
# [WUR Mini MOOC] <img src="https://www.wur.nl/upload/5e55a1d9-47c3-4149-9384-26d5147ee2d7_WUR_RGB_standard.png" alt="WUR logo" style="height: 35px;"/>
...
pacman::p_load(rgdal,rgeos,raster,plyr,dplyr,foreach,purrr,data.table,doParallel,plotrix,stringr, gfcanalysis,randomForest,BIOMASS)

# Global variables, change accordingly e.g. "C:/PlotToMap"
mainDir <- "F:/PlotToMap"
